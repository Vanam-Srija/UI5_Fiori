		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Basics",
									"targetURL": "#comsapfioribasicssapfioribasics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapfioribasicssapfioribasics-display": {
								"semanticObject": "comsapfioribasicssapfioribasics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.fiori.basics.sapfioribasics",
									"url": sap.ui.require.toUrl("com/sap/fiori/basics/sapfioribasics")
								}
							}
						}
					}
